...
function get_remote_data($url, $post_paramtrs=false)	{
	...
	if(!empty($GLOBALS['CURL_headerFuncttt'])) { curl_setopt($c, CURLOPT_HEADERFUNCTION, $GLOBALS['CURL_headerFunct']);  } 
	...
	return ( !empty($GLOBALS['RETURNNN_FULL_ARRAY']) ? array('data'=>$data,'status'=>$status) : $data);
}
